...
class ConfirmCode extends StatefulWidget {
  ...
  @override
  State<ConfirmCode> createState() => _ConfirmCode();
}
    ...
    return  Padding(
      ...
      child: Container(
        ...
        child: AnimatedButton(
          isLoading:Provider.of<ForgetPasswordViewModel>(context).isConfirmCodeLoading ,
          title: "send".tr(),
          onPressed: () {
            if(formKey.currentState!.validate()){
              Provider.of<ForgetPasswordViewModel>(context,listen: false).confirmCode(context: context, email: emailController.text,code: codeController.text);
            }
          },
          fontWeight: FontWeight.w400,
